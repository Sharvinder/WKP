...
public class UserController {
	...
	@RequestMapping("/employee/employeename/{empId}")
	public Iterable<EmployeeDetails> getEmployeeName(@PathVariable int empId) {
		return empService.getEmployeeName(empId);
	}
}
